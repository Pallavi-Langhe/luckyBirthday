...
export default function App() {
  ...
  const luckygiff = (
    <img
      alt="happyImage"
      src={"https://thumbs.gfycat.com/RecentHighCreature-size_restricted.gif"}
      width="100%"
      height="auto"
    />
  );
  const unluckygiff = (
    <img
      alt="unhappyImage"
      src={"https://media3.giphy.com/media/qBVEww0YjwWyI/giphy.gif"}
      width="100%"
      height="auto"
    />
  );
  ...
  return (
    <div className="App">
      ...
      <strong>
        <i>we're not storing your data</i>
      </strong>
    </div>
  );
}
